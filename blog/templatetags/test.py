# print(*(map(lambda x: f'COMMENT SHOULD BE DELETED' if x.isspace() or not x else x,
#                [input() for i in range(int(input()))])), sep='\n')
...
#
# print(*map(lambda x: x // 2, filter(lambda x: x < 47 or x > 47 and x % 2 == 0, numbers)))
