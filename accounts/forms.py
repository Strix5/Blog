...
class SignUpForm(UserCreationForm):
    ...
    def unique_email(self):
        ...
        if users.objects.filter(email=email).exists():
            return ValidationError('User with this e-mail already exists. Please, write new unique one.')
        return email
...
class UpdateProfileForm(forms.ModelForm):
    ...
    inf = forms.CharField(widget=forms.Textarea(attrs={"class": "form-control"}))
